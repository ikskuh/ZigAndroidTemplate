...
pub const struct_JNIInvokeInterface = extern struct {
    ...
    AttachCurrentThread: ?fn ([*c]JavaVM, [*c][*c]JNIEnv, ?*c_void) callconv(.C) jint,
    DetachCurrentThread: ?fn ([*c]JavaVM) callconv(.C) jint,
    GetEnv: ?fn ([*c]JavaVM, [*c]?*c_void, jint) callconv(.C) jint,
    AttachCurrentThreadAsDaemon: ?fn ([*c]JavaVM, [*c][*c]JNIEnv, ?*c_void) callconv(.C) jint,
};
...
pub const struct_JNINativeInterface = extern struct {
    ...
    GetPrimitiveArrayCritical: ?fn ([*c]JNIEnv, jarray, [*c]jboolean) callconv(.C) ?*c_void,
    ReleasePrimitiveArrayCritical: ?fn ([*c]JNIEnv, jarray, ?*c_void, jint) callconv(.C) void,
    ...
    NewDirectByteBuffer: ?fn ([*c]JNIEnv, ?*c_void, jlong) callconv(.C) jobject,
    GetDirectBufferAddress: ?fn ([*c]JNIEnv, jobject) callconv(.C) ?*c_void,
...
pub const AMOTION_EVENT_ACTION_MASK = @enumToInt(enum_unnamed_22.AMOTION_EVENT_ACTION_MASK);
pub const AMOTION_EVENT_ACTION_POINTER_INDEX_MASK = @enumToInt(enum_unnamed_22.AMOTION_EVENT_ACTION_POINTER_INDEX_MASK);
pub const AMOTION_EVENT_ACTION_DOWN = @enumToInt(enum_unnamed_22.AMOTION_EVENT_ACTION_DOWN);
pub const AMOTION_EVENT_ACTION_UP = @enumToInt(enum_unnamed_22.AMOTION_EVENT_ACTION_UP);
pub const AMOTION_EVENT_ACTION_MOVE = @enumToInt(enum_unnamed_22.AMOTION_EVENT_ACTION_MOVE);
pub const AMOTION_EVENT_ACTION_CANCEL = @enumToInt(enum_unnamed_22.AMOTION_EVENT_ACTION_CANCEL);
pub const AMOTION_EVENT_ACTION_OUTSIDE = @enumToInt(enum_unnamed_22.AMOTION_EVENT_ACTION_OUTSIDE);
pub const AMOTION_EVENT_ACTION_POINTER_DOWN = @enumToInt(enum_unnamed_22.AMOTION_EVENT_ACTION_POINTER_DOWN);
pub const AMOTION_EVENT_ACTION_POINTER_UP = @enumToInt(enum_unnamed_22.AMOTION_EVENT_ACTION_POINTER_UP);
pub const AMOTION_EVENT_ACTION_HOVER_MOVE = @enumToInt(enum_unnamed_22.AMOTION_EVENT_ACTION_HOVER_MOVE);
pub const AMOTION_EVENT_ACTION_SCROLL = @enumToInt(enum_unnamed_22.AMOTION_EVENT_ACTION_SCROLL);
pub const AMOTION_EVENT_ACTION_HOVER_ENTER = @enumToInt(enum_unnamed_22.AMOTION_EVENT_ACTION_HOVER_ENTER);
...
pub inline fn __BIONIC_CAST(_k: anytype, _t: anytype, _v: anytype) @TypeOf((@import("std").meta.cast(_t, _v))) {
